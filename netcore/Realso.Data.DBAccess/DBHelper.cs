...
namespace Realso.Data.DBAccess
{
  ...
  public class DBHelper : IDisposable
  {
    ...
    public DBHelper(string connectionString, Providers providers)
    {
      switch (providers)
      {
    ...
    public Task<int> ExecuteAsync(string sql, object param = null, IDbTransaction transaction = null) => Connection.ExecuteAsync(sql, param, transaction);
    ...
    public static object getParameters(Hashtable param)
    {
